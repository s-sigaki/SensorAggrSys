    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for(int i=0;i<TABLE_HEIGHT;i++){
            ...
            for(int j=0;j<TABLE_WIDTH;j++){
                ...
                SensorData cur_sensor=Ondotori.humidity_collection.getSensorAtLocation(i,j);
                int cur_value;
                if(cur_sensor==null){
                    cur_value=NO_VAL;
                }else{
        ...
        if(Ondotori.humidity_collection.get_avg_points().length>0) {
            ...
            if(Ondotori.humidity_collection.getLast_update_time()!=null){
