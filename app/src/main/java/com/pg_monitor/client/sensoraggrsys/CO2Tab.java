...
public class CO2Tab extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        value[2*TABLE_WIDTH]=6000;
        value[2*TABLE_WIDTH+1]=2000;
        value[3*TABLE_WIDTH]=400;
        value[4*TABLE_WIDTH]=350;
        value[5*TABLE_WIDTH]=500;
        value[6*TABLE_WIDTH]=600;
        value[7*TABLE_WIDTH]=3000;
        ...
        View space_view=(View)rootview.findViewById(R.id.space_view);
        space_view.getLayoutParams().width=45;
