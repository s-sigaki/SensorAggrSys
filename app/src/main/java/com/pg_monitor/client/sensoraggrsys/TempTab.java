    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(Ondotori.temperature_collection.get_avg_points().length>0) {
            ...
            if(Ondotori.temperature_collection.getLast_update_time()!=null){
                ...
                last_update_time_text_view.setText(DateStrCal.yMdhmsTohmsdMy(Ondotori.temperature_collection.getLast_update_time()));
            }
        ...
        if(Ondotori.temperature_collection.diffTime()==null){
            graph.getGridLabelRenderer().setHorizontalAxisTitle("No historical data");
            graph.getLegendRenderer().setVisible(true);
        }else{
            graph.getGridLabelRenderer().setHorizontalAxisTitle("Last "+Ondotori.temperature_collection.diffTime()+" (every "+DateStrCal.secondsToString(MainActivity.min_interval)+")");
            graph.getLegendRenderer().setVisible(true);
        }
        ...
        series_avg.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                ...
                String reportDate = DateStrCal.sub_sec_time(Ondotori.temperature_collection.getLast_update_time(), (int)dataPoint.getX() * MainActivity.min_interval);
